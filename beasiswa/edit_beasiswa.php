...
if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE tb_beasiswa SET nama='$nama', deskripsi='$deskripsi', jumlah='$jumlah' WHERE id=$id";
...
<body>
    ...
    <div class="container">
        <h2 class="my-4">Edit Beasiswa</h2>
        <div class="form-container">
            <form method="POST" action="">
                ...
                <div class="form-group">
                    <label for="jumlah">Jumlah Beasiswa</label>
