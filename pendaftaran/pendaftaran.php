...
<div class="container">
    ...
    <a href="crud_pendaftaran.php?action=create" class="btn btn-success">Tambah Pendaftaran</a>
            ...
            <tbody>
                <?php while($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td class="actions">
                            <a href="crud_pendaftaran.php?action=edit&id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Edit</a>
                            <form action="crud_pendaftaran.php?action=delete" method="POST" style="display:inline-block;">
