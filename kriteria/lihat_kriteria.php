...
<body>
    ...
    <div class="container">
        <h2 class="my-4">Daftar Kriteria</h2>
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $row['bobot'] ?></td>
                    <td>
                        <a href="edit_kriteria.php?id=<?= $row['id'] ?>" class="btn btn-success" data-toggle="tooltip" title="Edit">Edit</a>
                        <a href="hapus_kriteria.php?id=<?= $row['id'] ?>" class="btn btn-danger" data-toggle="tooltip" title="Hapus" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
                    </td>
                </tr>
                <?php endwhile; ?>
            </tbody>
